...
#    permutation_count_list = [i for i in range(100,501, 100)]
    permutation_count_list = [i for i in range(100,500, 100)]

    #results_file_name = "%s%sx%d"%(corpus_name,str(permutation_count_list),permutation_repetition)
    slots_range = [2,4,8,12,16,20,24,28,32,36,40,44,48]
    for n_slots in slots_range:        
        ...
        np.save("../results/test_n_slots/dict_" + str(n_slots) +".npy", results) 
        ''' 
           Plot code
        '''
        results_file_name = "../results/test_n_slots/ploty_" + str(n_slots)        
